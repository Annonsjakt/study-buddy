...
export async function renderLibrary() {
  ...
  // Colour-code library subjects the same way the rest of the app does —
  // if this subject's already in the student's own library (by name), reuse
  // its real colour so it matches the home menu/progress page; otherwise
  // assign one by position in its level so subjects are still visually
  // distinct while browsing, before anything's been added.
