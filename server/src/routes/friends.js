...
// This week's questions answered, and current streak, for the signed-in
// user and every active friend — resets weekly (a lifetime-total leaderboard
// would just be permanently led by whoever joined first, which isn't much
// of a competition). Streak/week boundaries are computed here in server UTC
// rather than each student's own local time, since nothing in state_blobs
// records a timezone — close enough for a friendly comparison, not meant to
// be exact to the hour.
